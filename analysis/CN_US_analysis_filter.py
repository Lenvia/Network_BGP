...
temp_list2 = [1, 2, 4, 8, 16, 32, 64, 128, 256, 512, 1024, 2048]
...
def draw_prefix_graph(CN_outdegrees, US_outdegrees):
    ...
    plt.show()
    # plt.savefig('/Users/yy/Desktop/filtered_prefix_CN_US.png')
    # clf()  # 清图。
    # cla()  # 清坐标轴。
    # close()  # 关窗口
...
def draw_suffix_graph(CN_outdegrees, US_outdegrees):
    ...
    # plt.title("A simple plot") #标题
    # plt.show()
    plt.savefig('/Users/yy/Desktop/filtered_suffix_CN_US.png')
    clf()  # 清图。
    cla()  # 清坐标轴。
    close()  # 关窗口
...
if __name__ == '__main__':
    ...
    # 中国
    CN_CSV = open("../outputs_CN_US/filtered_nodes_ipv4&6_2021_CN.csv", "r", encoding='utf8')
    ...
    # 美国
    US_CSV = open("../outputs_CN_US/filtered_nodes_ipv4&6_2021_US.csv", "r", encoding='utf8')
